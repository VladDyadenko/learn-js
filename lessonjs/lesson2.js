...
// ----------------------------------------------------
// Пример 12 — Ввод пользователя и ветвления
// Напишите скрипт, который будет спрашивать логин с помощью
// promptи логировать результат в консоли.

// Если посетитель вводит "Админ", то promptзапрашивает пароль
// Если ничего не введено или не нажата клавиша Esc - вывести
// строку"Отменено"
// В случае необходимости"Я вас не знаю"
// Пароль проверки так:

// Если введен пароль "Я админ", то вывести результат"Здравствуйте!"
// Выводить кожу"Неверный пароль"
...
// Пример 9 - Дедлайн сдачи проекта (if...else)
// Напишите скрипт для отображения времени дедлайна сдачи проекта.
...
// Если до дедлайна 3+ дня - выведи строку"Дата в будущем"


// const daysUntilDeadline = prompt("Скількі днів до захисту проекту?");
...
//     alert("Та ще не скоро")
// } else  {
//     alert("Да коли це ще буде!")
// };

// Напишите скрипт, который будет выводить в консоль браузера, в
// зависимости от значения устанавливает hours.

// Если значение устанавливается hours:

// меньше 17, выводы"Pending"
// больше либо равно 17и либо меньше равно 24, выводы строки"Expires"
// больше 24, выводы статьи"Overdue"
...
// Пример 6 - Форматирование посилання (включает та логічне «І»)
// Напишите скрипт, который перевирается и закінчується значення 
// смінної link символом /.Якщо нет, додай до linkконца значение 
// этого символа, але тільки в том числе випадку, якщо в link є 
// підрядок "my-site".Використовуй конструкцію if...else.
